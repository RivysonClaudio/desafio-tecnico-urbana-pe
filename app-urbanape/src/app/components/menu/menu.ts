...
export interface MenuItem {
  label: string;
  route: string;
  icon?: 'home' | 'users' | 'cards' | 'settings' | 'logout';
}
...
export class MenuComponent {
  ...
  getIconSvg(icon?: string): string {
    const icons: Record<string, string> = {
      ...
      cards: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      logout: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
